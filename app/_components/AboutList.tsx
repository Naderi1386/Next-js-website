    ...
    <div className="text-white mt-16  px-2 lg:px-16 ">
      <div className="flex flex-col custome-lg:flex-row custome-lg:items-center custome-lg:justify-between gap-10">
        ...
        <div className="basis-full custome-lg:basis-[50%] relative">
          <div className="w-[100%] sm2x:w-[70%] relative h-[480px]">
            <Image
          ...
          <div className="w-[240px] h-[290px] sm2x:w-[320px] sm2x:h-[365px] absolute right-[.0005rem] sm2x:right-[2.5rem] bottom-10 sm2x:bottom-16 backdrop-blur-[6px] border border-solid border-white/10"></div>
