...
const FirstSection = () => {
  return (
    <div className=" bg-gradient-to-b from-[#1d293d] to-[#0c0a09] custome-lg:bg-gradient-to-r custome-lg:from-[#0c0a09] custome-lg:to-[#1d293d] text-white px-8 sm:px-28 py-40">
