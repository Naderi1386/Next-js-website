...
const SearchBox = ({ handleChange }: SearchBoxPropsType) => {
  const [inputVal, setInputVal] = useState("aaaa");
  return (
    <div>
      <div
        className="flex items-center justify-center fixed inset-0  backdrop-brightness-50 backdrop-blur-[2px] text-white"
        onClick={() => handleChange(false)}
      >
        <div className="w-[600px] h-[550px] bg-[#111722]  rounded-[8px]">
